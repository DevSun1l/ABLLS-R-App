  ...
  return (
    <div className="max-w-4xl mx-auto space-y-12 animate-in fade-in duration-700">
      ...
      <form onSubmit={handleSave} className="bg-white border border-outline-variant/10 rounded-[3rem] p-12 shadow-sm space-y-10">
        <div className="space-y-4">
          <label className="text-xs font-black text-primary uppercase tracking-[0.3em] ml-6">Full Identity Name</label>
          <input 
            type="text" required
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="space-y-4">
            <label className="text-xs font-black text-primary uppercase tracking-[0.3em] ml-6">Age (Chronological Years)</label>
            <select 
          ...
          <div className="space-y-4">
            <label className="text-xs font-black text-primary uppercase tracking-[0.3em] ml-6">Developmental Months</label>
            <select 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="space-y-4">
            <label className="text-xs font-black text-primary uppercase tracking-[0.3em] ml-6">Assessor Signature</label>
            <input 
              type="text" required
          ...
          <div className="space-y-4">
            <label className="text-xs font-black text-primary uppercase tracking-[0.3em] ml-6">Assessment Date</label>
            <input 
              type="date" required
        ...
        <div className="space-y-6">
          <label className="text-xs font-black text-primary uppercase tracking-[0.3em] ml-6">Clinical Observations (Diagnoses)</label>
        ...
        <div className="space-y-4">
          <label className="text-xs font-black text-primary uppercase tracking-[0.3em] ml-6">Session Qualitative Notes</label>
          <textarea 
            rows="5"
        ...
        <div className="pt-10 flex flex-col md:flex-row justify-end gap-4 border-t border-outline-variant/5">
           <button 
             ...
             className="px-8 py-5 font-black text-xs uppercase tracking-[0.3em] text-on-surface-variant hover:bg-surface-container-high rounded-full transition-all"
           >
             Discard Entry
           </button>
           <button 
             ...
             className="px-8 py-5 font-black text-xs uppercase tracking-[0.3em] text-primary bg-primary-container rounded-full hover:bg-primary/20 transition-all active:scale-[0.98] flex items-center justify-center gap-3 border border-primary/10"
           >
           ...
           <button 
             ...
             className="px-10 py-5 font-black text-xs uppercase tracking-[0.3em] text-on-primary bg-primary rounded-full hover:bg-primary-dim shadow-xl shadow-primary/20 transition-all hover:shadow-2xl active:scale-[0.98] flex items-center justify-center gap-3"
           >
